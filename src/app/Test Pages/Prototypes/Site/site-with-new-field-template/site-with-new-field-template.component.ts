...
@Component({
  selector: 'fcid-site-with-new-field-template',
  templateUrl: './site-with-new-field-template.component.html',
  styleUrls: ['./site-with-new-field-template.component.scss']
})
export class SiteWithNewFieldTemplateComponent implements OnInit {
  client: ClientModule;
  ...
  public get serviceURL(): string {
    ...
    if (this.startupConfig.startupData && this.startupConfig.startupData.ASPNETCORE_ENVIRONMENT) {
      this._serviceURL = `https://foodchainidbusinessmetadata2018091812145-${this.startupConfig.startupData.ASPNETCORE_ENVIRONMENT.toLowerCase()}.azurewebsites.net/`;
